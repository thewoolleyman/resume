...
Delivery is phased. Phase 1 MUST deliver the interactive and static resume modes with predecessor parity fully specified and drive-able before implementation begins. AI-driven mode and the MCP surface remain planned product surfaces, but their detailed retrieval, provider, tool, and protocol behavior is deferred to a later phase and MUST remain non-load-bearing until a future proposed change specifies it.
