...
The phase-1 browser metadata surface MUST make an explicit PWA installability decision. It MUST either serve a documented web-app manifest with standalone display metadata and app icons, or document PWA installability as intentionally out of scope for the initial port before implementation claims predecessor metadata parity.
